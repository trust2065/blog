...
- **解鎖方式**: 請確保你在 GitHub Repo 的 **Settings -> Secrets and variables -> Actions** 裡面已經新增了一組名為 `PRIVATE_POST_PASSWORD` 的密碼。如果別人取得你的文章直接連結（例如 `https://trust2065.github.io/blog/posts/private/test/`），必須輸入這個密碼才能看到內容。
